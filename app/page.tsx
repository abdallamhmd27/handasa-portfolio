...
export default function Home(){
  ...
  return <main className={`site${rtl?" rtl":""}${isAndroid?" android":""}`} dir={rtl?"rtl":"ltr"}>
    ...
    <section className="morehCase" id="moreh-case">
      ...
      <div className="morehCreatives"><div className="reelShowcaseHead"><p>{rtl?"كريتيفز الحملة":"CAMPAIGN CREATIVES"}</p><span>{rtl?"عينات مختارة من الفيديوهات التي تم تنفيذها":"SELECTED EXECUTED VIDEO SAMPLES"}</span></div><div className="morehCreativeGrid reelGrid">
