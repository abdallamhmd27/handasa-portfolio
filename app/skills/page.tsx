...
const hubCopy = {
  en: {
    ...
    skills: [
      ...
      ["03", "AI Visual Production", "Producing model and campaign visuals with AI-led creative workflows.", "", "AI"],
  ...
  ar: {
    ...
    skills: [
      ...
      ["03", "إنتاج الصور بالـAI", "إنتاج صور موديلز وكامبينز من خلال عمليات إبداعية تعتمد على الذكاء الاصطناعي.", "", "AI"],
